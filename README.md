...
앤보임 영어회화 자동화 관리 시스템은 플래너가 카카오톡을 통해 수행하던 수강생 관리, 숙제 배정, 피드백 제공 업무를 전용 모바일 앱으로 자동화하는 시스템입니다. 

### 핵심 기능
- 🎥 MP4 동영상에서 MP3 음성 자동 추출 (90MB → 5-10MB, 90% 비용 절감)
- 🤖 AI 기반 음성 분석 및 발음 평가 (Azure Speech Service + OpenAI)
- 📱 플래너/학생 전용 React Native 모바일 앱
