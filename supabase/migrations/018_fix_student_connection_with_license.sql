-- ============================================================================
-- 학생 연결 함수 수정 (라이선스 기반 학생수 제한 적용)
-- 작성일: 2026.01.17
-- 목적: invite_codes 테이블 제거, planner_profiles.invite_code 사용
--       licenses 테이블 기반 학생수 제한 실시간 체크
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Student connection function updated successfully';
    RAISE NOTICE '📊 Now using: planner_profiles.invite_code (not invite_codes table)';
    RAISE NOTICE '🔒 License-based student limit: Real-time blocking enabled';
    RAISE NOTICE '⚡ Student registration will be blocked when max_students is reached';
END $$;
