...
export async function POST(req: NextRequest) {
  try {
          ...
          <div style="padding: 30px 20px; background-color: #f9fafb; border-radius: 0 0 12px 12px;">
            ...
            <div style="background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 8px; padding: 25px; margin-bottom: 30px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  ...
                  <td style="padding: 8px 0; color: #212529; font-size: 16px; text-align: right; font-weight: bold;">우리은행</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #856404; font-size: 14px;">계좌번호</td>
                  <td style="padding: 8px 0; color: #212529; font-size: 16px; text-align: right; font-weight: bold;">1002-123-456789</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #856404; font-size: 14px;">예금주</td>
                  <td style="padding: 8px 0; color: #212529; font-size: 16px; text-align: right; font-weight: bold;">엔보임플래너프로</td>
                </tr>
              </table>
            </div>
            ...
            <div style="background: #ffebee; border-left: 4px solid #dc2626; border-radius: 8px; padding: 25px; margin-bottom: 30px;">
              ...
              <div style="color: #991b1b; font-size: 14px; line-height: 1.8;">
                <p style="margin: 0 0 15px 0;">
                  <strong>입금 시 입금자명에 주문번호를 반드시 포함해주세요!</strong>
                </p>
                <p style="margin: 0 0 10px 0; background: #ffffff; padding: 12px; border-radius: 6px;">
                  <strong>입금자명 예시:</strong><br>
                  • <span style="color: #dc2626; font-weight: bold;">${orderId}</span><br>
                  • <span style="color: #dc2626; font-weight: bold;">${customerName}${orderId.slice(-4)}</span>
                </p>
                <p style="margin: 0; font-size: 13px;">
                  ※ 주문번호가 입금자명에 포함되어야 자동 매칭이 가능합니다.<br>
                  ※ 주문번호 없이 입금하시면 수동 확인이 필요하여 처리가 지연됩니다.
                </p>
              </div>
            </div>
            ...
            <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
              ...
              <ol style="margin: 0; padding-left: 20px; color: #374151; font-size: 14px; line-height: 1.8;">
                ...
                <li style="margin-bottom: 8px;"><strong>입금자명에 주문번호를 포함</strong>하세요. (예: ${orderId})</li>
                <li style="margin-bottom: 8px;">입금이 확인되면 자동으로 라이선스 키가 발급됩니다.</li>
    ...
    console.log('[Payment Email] Sent successfully to:', to);

    return NextResponse.json({
      success: true,
      message: 'Payment info email sent successfully',
      orderId: orderId
    });
