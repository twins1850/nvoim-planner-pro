...
(async () => {
  console.log('🧪 Testing trial signup on LOCALHOST...\n');
  ...
  try {
    console.log('1. Opening localhost:3000...');
    await page.goto('http://localhost:3000', {
      waitUntil: 'networkidle',
      timeout: 30000
    });
    console.log('✅ Local site loaded');
    ...
    if (bodyText.includes('이미 체험 라이선스를 사용')) {
      console.log('❌ Device already used trial (even on localhost!)');
      console.log('   This means the database still has the fingerprint.');
    } else if (bodyText.includes('무료 체험 시작')) {
      console.log('✅✅ Trial eligibility PASSED on localhost!');
      ...
      if (finalUrl.includes('/dashboard')) {
        ...
        console.log('   ✅ The RLS fix is working on localhost!');
